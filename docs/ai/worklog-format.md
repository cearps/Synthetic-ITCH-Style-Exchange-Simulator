...
This document defines where and how AI agents should record work performed on the repository.
...
Each entry should be appended to the end of the file and contain:

1. A short header that includes date, author, and scope
